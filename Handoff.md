...
Last updated: 2026-07-07 | Last pushed: `update#43` (docs: CSP-differs-on-index QA corollary) | Next commit: `update#44` | CSS cache: `?v=32`
...
- **Commit**: `website update#N` only — nothing else. Next is `update#44`.
