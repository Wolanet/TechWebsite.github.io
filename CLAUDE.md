...
5. **Current CSS cache version: `?v=30`** (theme.css changed for update#32 — hero wave-band rework; jumped v25→v30 across several in-session preview iterations). Next CSS/JS change → bump to `?v=31`.
6. **Next commit number: `update#34`.**
